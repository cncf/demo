...
output "ssh-key-setup" { value = "eval $(ssh-agent) ; ssh-add data/ii-cncfdemo.pem"}
output "ssh-via-bastion" { value = "ssh -At ${ var.admin_username }@${ module.bastion.ip } ssh ${ var.admin_username }@master1.cncf.demo"}
